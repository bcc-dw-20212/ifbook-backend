...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["primario"], ["user.id"], name=op.f("fk_amizade_primario_user")
        ),
        sa.ForeignKeyConstraint(
            ["secundario"], ["user.id"], name=op.f("fk_amizade_secundario_user")
        ),
        sa.PrimaryKeyConstraint(
            "primario", "secundario", name=op.f("pk_amizade")
        ),
    )
    op.create_table(
        "cursos_alunos",
        ...
        sa.ForeignKeyConstraint(
            ["aluno"], ["user.id"], name=op.f("fk_cursos_alunos_aluno_user")
        ),
        sa.ForeignKeyConstraint(
            ["curso"], ["curso.id"], name=op.f("fk_cursos_alunos_curso_curso")
        ),
        sa.PrimaryKeyConstraint(
            "aluno", "curso", name=op.f("pk_cursos_alunos")
        ),
    )
